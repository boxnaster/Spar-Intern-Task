...
struct FoodCardGridView: View {
    ...
    var body: some View {
        VStack {
            ...
            Spacer()
            CardContentGridView(foodProductId: foodProduct.id, foodProductName: foodProduct.name, foodProductCountry: foodProduct.country, foodProductPrice: foodProduct.price, foodProductOldPrice: foodProduct.oldPrice, foodProductIsSoldByWeight: foodProduct.isSoldByWeight, onAddToCart: onAddToCart, onRemoveFromCart: onRemoveFromCart)
        }
    }
}
