...
struct FoodCardListView: View {
    ...
    var body: some View {
        HStack {
            ...
            CardContentListView(foodProduct: foodProduct, onAddToCart: onAddToCart, onRemoveFromCart: onRemoveFromCart, isFavorite: isFavorite, toggleFavorite: toggleFavorite, isInShopList: isInShopList, toggleShopList: toggleShopList)
        }
    }
}
