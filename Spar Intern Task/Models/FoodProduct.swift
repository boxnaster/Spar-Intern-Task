...
struct FoodProduct: Identifiable {
    ...
    static func getExamples() -> [FoodProduct] {
        return [FoodProduct(id: 1, name: "Огурцы тепличные садово-огородные 500гр", image: Image("cucumbers"), isFavorite: true, isInTheShopList: false, rating: 3.0, reviewsCount: 12, isSoldByWeight: false, price: 199.90, oldPrice: 210.10, discount: 50, badge: Badge(text: "Новинки", color: Color(red: 122/255, green: 121/255, blue: 186/255, opacity: 0.9)), quantityType: QuantityType(title: "Кг", step: 0.1)),
                FoodProduct(id: 2, name: "Липа сушеная", image: Image("linden"), isFavorite: false, isInTheShopList: false, rating: 4.8, reviewsCount: 23, isSoldByWeight: true, price: 65.50, oldPrice: 70.20, country: "Россия🇷🇺", discount: 25, badge: Badge(text: "Удар по ценам", color: Color(red:252/255, green: 106/255, blue: 111/255, opacity: 0.9)), quantityType: QuantityType(title: "Кг", step: 0.1)),
                ...
                FoodProduct(id: 4, name: "Сладкий миндаль", image: Image("almond"), isFavorite: false, isInTheShopList: false, rating: 5.0, reviewsCount: 10, isSoldByWeight: true, price: 340.50, country: "Испания🇱🇰", discount: 30, quantityType: QuantityType(title: "Кг", step: 0.1))]
    }
}
